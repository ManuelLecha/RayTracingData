...
template<typename genIUType, typename sizeType>
GLM_FUNC_QUALIFIER detail::tvec2<genIUType>
extractField
(
...
template<typename genIUType, typename sizeType>
GLM_FUNC_QUALIFIER detail::tvec3<genIUType>
extractField
(
...
template<typename genIUType, typename sizeType>
GLM_FUNC_QUALIFIER detail::tvec4<genIUType>
extractField
(
...
GLM_FUNC_QUALIFIER detail::tvec2<int>
lowestBit
(
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tvec3<int>
lowestBit
(
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tvec4<int>
lowestBit
(
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tvec2<bool>
isPowerOfTwo
(
        detail::tvec2<valType>
const & value
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tvec3<bool>
isPowerOfTwo
(
        detail::tvec3<valType>
const & value
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tvec4<bool>
isPowerOfTwo
(
        detail::tvec4<valType>
const & value
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tvec2<valType>
bitRotateRight
(
        detail::tvec2<valType>
const & Value,
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tvec3<valType>
bitRotateRight
(
        detail::tvec3<valType>
const & Value,
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tvec4<valType>
bitRotateRight
(
        detail::tvec4<valType>
const & Value,
