...
namespace glm {
    ...
    GLM_FUNC_QUALIFIER std::string
    to_string(detail::half
    const & x) {
    return detail::format("half(%2.4f)",
    float(x)
    );
}
...
to_string
(
        detail::tvec2<detail::half>
const & v
)
{
return detail::format("hvec2(%2.4f, %2.4f)", v.x.
...
{
return detail::format("hvec3(%2.4f, %2.4f, %2.4f)", v.x.
...
{
return detail::format("hvec4(%2.4f, %2.4f, %2.4f, %2.4f)", v.x.
