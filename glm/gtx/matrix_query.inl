...
bool result(true);
for(
typename detail::tmat2x2<genType>::size_type i(0);
result &&i<m
.
...
for(
typename detail::tmat2x2<genType>::size_type j(0);
j<m.
...
bool result(true);
for(
typename detail::tmat3x3<genType>::size_type i(0);
result &&i<m
.
...
for(
typename detail::tmat3x3<genType>::size_type j(0);
j<m.
...
bool result(true);
for(
typename detail::tmat4x4<genType>::size_type i(0);
result &&i<m
.
...
for(
typename detail::tmat4x4<genType>::size_type j(0);
j<m.
