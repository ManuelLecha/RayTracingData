...
namespace glm {
    namespace detail {
        ...
        GLM_FUNC_QUALIFIER fmat4x4SIMD::size_type

        fmat4x4SIMD::value_size() {
            return sizeof(value_type);
        }

        GLM_FUNC_QUALIFIER fmat4x4SIMD::size_type

        fmat4x4SIMD::col_size() {
            return 4;
        }

        GLM_FUNC_QUALIFIER fmat4x4SIMD::size_type

        fmat4x4SIMD::row_size() {
            return 4;
        }
...
GLM_FUNC_QUALIFIER detail::tmat4x4<float>
mat4_cast
(
        detail::fmat4x4SIMD
const & x
