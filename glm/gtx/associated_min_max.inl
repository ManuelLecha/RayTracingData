...
template<typename T, typename U>
GLM_FUNC_QUALIFIER detail::tvec2<U>
...
template<typename T, typename U>
GLM_FUNC_QUALIFIER detail::tvec3<U>
...
template<typename T, typename U>
GLM_FUNC_QUALIFIER detail::tvec4<U>
...
detail::tvec2 <U> Result;
for(
typename detail::tvec2<U>::size_type i = 0;
i<detail::tvec2<U>::value_size;
++i)
...
detail::tvec3 <U> Result;
for(
typename detail::tvec3<U>::size_type i = 0;
i<detail::tvec3<U>::value_size;
++i)
Result[i] = x<y ? a[i] : b[i];
return
Result;
...
detail::tvec4 <U> Result;
for(
typename detail::tvec4<U>::size_type i = 0;
i<detail::tvec4<U>::value_size;
++i)
Result[i] = x<y ? a[i] : b[i];
return
Result;
