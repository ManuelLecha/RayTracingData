...
namespace glm {
    ...
    GLM_FUNC_QUALIFIER detail::tmat2x2<valType>
    diagonal2x2
    (
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tmat2x3<valType>
diagonal2x3
(
        detail::tvec2<valType>
const & v
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tmat2x4<valType>
diagonal2x4
(
        detail::tvec2<valType>
const & v
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tmat3x2<valType>
diagonal3x2
(
        detail::tvec2<valType>
const & v
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tmat3x3<valType>
diagonal3x3
(
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tmat3x4<valType>
diagonal3x4
(
        detail::tvec3<valType>
const & v
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tmat4x4<valType>
diagonal4x4
(
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tmat4x3<valType>
diagonal4x3
(
        detail::tvec3<valType>
const & v
...
template<typename valType>
GLM_FUNC_QUALIFIER detail::tmat4x2<valType>
diagonal4x2
(
        detail::tvec2<valType>
const & v
